...
const { criarGrupo, montarLinkGrupo, extrairIdGrupo, gerarInviteGrupo, config: configWaha } = require('./waha');
...
async function enviarConvites(interesse, grupoLink) {
  ...
  const template = (config && config.template_nome) || 'convite_grupo_proprietario';
...
module.exports = { garantirGrupo, enviarConvites, emitirToken, registrarTentativa };
